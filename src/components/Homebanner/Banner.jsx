...
const Banner = () => {
    return (
        <div className="   bg-cover bg-center h-[750px]" style={{ backgroundImage: `url(${bgImg})` }}>
            <div className=' bg-gradient-to-b from-transparent via-transparent via-transparent to-white flex lg:flex-row flex-col-reverse justify-center items-center gap-9 h-full px-6 lg:px-2 md:pt-20'>
